...
export type Mutations<S = State> = {
  [MutationTypes.SET_LIST](state: S, payload: ServerModel[]): void;
};

export type Getters = {
  find(...context: GetterContext<State, Getters>): (id: string) => ServerInterface | undefined;
};
